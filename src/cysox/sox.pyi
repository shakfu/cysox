...
# Cython compiles this from the linked sox.h, so the member *values* depend on
# which libsox is built against. Always compare symbolically.
class sox_encoding_t(enum.IntEnum):
