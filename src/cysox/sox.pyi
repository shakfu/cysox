...
class Format:
    ...
    def read_into(self, buffer: Any) -> int: ...
...
class Effect:
    ...
    def __init__(self, handler: Optional[EffectHandler]) -> None: ...
    def set_options(self, options: List[Any]) -> int: ...
    def stop(self) -> int: ...
...
class EffectsChain:
    ...
    def flow_effects(
        self,
        callback: Optional[Callable[[bool, Any], Optional[int]]] = None,
...
class SoxRuntime:
    ...
    _instance: Optional["SoxRuntime"]
    initialized: bool

    def ensure_init(self) -> None: ...
    def force_quit(self) -> None: ...
    def register_callback(
        self, chain_id: int, callback: Any, client_data: Any
    ) -> None: ...
    def unregister_callback(self, chain_id: int) -> None: ...
    def get_callback(self, chain_id: int) -> Optional[tuple]: ...
    def set_last_exception(self, exc_info: Optional[tuple]) -> None: ...
    def pop_last_exception(self) -> Optional[tuple]: ...
...
# Sample I/O
def read_samples(format: Format, buffer: List[int], length: int) -> int: ...
def write_samples(format: Format, samples: List[int]) -> int: ...
